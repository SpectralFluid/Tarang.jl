# ============================================================================
# has() method - Dedalus pattern for checking if expression contains variables
# See dedalus/core/field.py:362-365 and dedalus/core/future.py:108-115
# ============================================================================
...
This is the Dedalus pattern for linearity checking.
...
function has(field::ScalarField, vars...)
    # Field.has from Dedalus: returns (not vars) or (self in vars)
...
Following Dedalus pattern from arithmetic.py.
...
function Base.copy(field::ScalarField)
    ...
    # Copy only the data arrays that exist
